...
//   // 	key = CryptoJS.enc.Utf8.parse(runtime.objects.Store.getFirstInstance().value);
...
// //     await runtime.assets.loadScripts("crypto-js.js");

// 	key = Utils.CryptoJS.enc.Utf8.parse(secretkey);
// 	iv = Utils.CryptoJS.enc.Utf8.parse(secretkey.substring(0, 16));
...
module.exports = async function encryptTxt(key, txt) {
  let cipherText = CryptoJS.AES.encrypt(txt, CryptoJS.enc.Utf8.parse(key), {
...
// async function abcd() {
//   const text = // '15.4^15.4^932547^7^1662227536553_123456';
//     50 + '^' + 50 + '^' + 932547 + '^' + 7 + '^' + '1662267579146_123456';
//   console.log(text);
//   const data = await encryptTxt('bItOnE0414!AgAMe', text);
//   return data;
// }
